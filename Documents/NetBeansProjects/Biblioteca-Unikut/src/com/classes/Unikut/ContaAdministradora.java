...
public class ContaAdministradora extends Conta {
    ...
    public void exibeContaAdm (Conta exibir){
        if(exibir == null){
            ...
            if(exibir.getNome().compareTo("null")==0 || exibir.getNome().compareTo("convidado")==0){
